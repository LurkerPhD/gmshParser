...
XMLElement *XMLNode::QueryElementByAttribute(const char *ChildName, const char *AttriName, const char *AttriValue)
{
...
XMLElement *XMLNode::FindOrCreatChildElement(const char *ChildName, const char *AttriName, const char *AttriValue)
{
    XMLElement *child = this->QueryElementByAttribute(ChildName, AttriName, AttriValue);
    if (child == NULL)
    {
        XMLDocument *doc = GetDocument();
        child = doc->NewElement(ChildName);
